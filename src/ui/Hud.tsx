 ...
 *
 * Every number here is MEASURED — reps, clean reps, elapsed time, fps all come
 * from the pose engine. Nothing on this panel may be modelled or estimated: the
 * simulated heart rate that used to sit under the rep row was removed for exactly
 * that reason (amendment 2 in src/types/tools.ts).
 */
